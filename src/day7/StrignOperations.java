...
public class StrignOperations {
	...
	public static void main(String[] args) {
		...
		System.out.println(s.charAt(0));  //w   welcome
		System.out.println(s.charAt(3));  //c   0123456
		...
		s="welcome";                              // Starting Index 0123456
		System.out.println(s.substring(2, 5)); //lco                welcome
		System.out.println(s.substring(0,6)); //welcom Ending index 1234567
		
		//split() - divide the string into multiple parts using delimeter	
		// Written array of strings
		// should not use  *  $   ^ ? .   + -
		// delimiters are the characters that split (separate) the string into tokens/parts
		s="abc@gmail.com";
